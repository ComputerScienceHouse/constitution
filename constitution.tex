...
The ballots are collected for a minimum of forty-eight hours.
...
\begin{enumerate}
	...
	\item If the nomination is presented at a House Meeting for discussion, a Two-Thirds Vote with two-thirds quorum is held to determine whether the nomination is accepted.
	      Ballots are distributed and voting must remain open for a minimum of forty-eight hours.
...
\begin{enumerate}
	\item CSH may choose to waive the following subset of the qualifications for E-Board positions, as defined under \ref{Qualifications}, for all candidates:
	      \begin{enumerate}
		      ...
		      \item Social, R\&D, and Ad Hoc Directors are the only E-Board positions that allow for dual directorship.
	      \end{enumerate}
	...
	\item The waiver for dual directorship may never be applied to the positions of Chairperson, Evaluations Director, or Financial Director.
\end{enumerate}

\asubsection{Selection}

\asubsubsection{Dual Directors}
Social, R\&D, and Ad Hoc Directors are the only E-Board positions that allow for dual directors.
...
\begin{enumerate}
	\item The opening of the E-Board position(s) is announced at a House Meeting and nominations for the position are taken for a minimum of seventy-two hours.
	...
	\item The candidates will be notified of their nomination.
	      Each candidate is given a minimum of twenty-four hours to accept or decline the nomination.
	...
	\item Ballots will then be distributed for a Balloted Vote \ref{Balloted Vote} and voting will be open for a minimum of forty-eight hours.
...
\begin{enumerate}
	...
	\item Ballots will then be distributed and a Secret Ballot Vote shall be held for a minimum of forty-eight hours to determine whether or not the member should be removed from office.
...
\begin{enumerate}
	...
	\item Each candidate is given a minimum of twenty-four hours to accept or decline the nomination.
